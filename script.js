...
(function () {
  ...
  Waves.prototype.updateColor = function () {
    ...
    // var r = Math.floor(10 * Math.sin(0.3 * Waves.hue + 0) + window.colorOption.red)
    // var g = Math.floor(
    //   10 * Math.sin(0.3 * Waves.hue + 9) + window.colorOption.green
    // )
    // var b = Math.floor(
    //   10 * Math.sin(0.3 * Waves.hue + 20) + window.colorOption.blue
    // )
  ...
  Wave.prototype.draw = function () {
    ...
    each(Lines, function (line, i) {
      ...
      var gradient = ctx.createLinearGradient(0, 0, cpy2, 0)
      gradient.addColorStop('0', 'rgba(0,0,184, 1)')
      gradient.addColorStop('1.0', 'rgba(204,0,0, 1')
            

      // gradient.addColorStop('0', 'rgba(212,93,202, 0.1)')
      // gradient.addColorStop('1.0', 'rgba(122,181,219, 0.1')
